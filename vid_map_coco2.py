...
from nets.BeltCrackNet import slowfastnet as Network      
# from nets.yolo import YoloBody as Network
...
from pycocotools.cocoeval import COCOeval  # 输出指标格式
...
#   指向了验证集标签与图片路径
#-------------------------------------------------------#
cocoGt_path         = '/home/hjh/BeltCrack14ks/annotations/test/coco.json'
dataset_img_path    = '/home/hjh/BeltCrack14ks/'
...
#   结果输出的文件夹，默认为map_out
#-------------------------------------------------------#
temp_save_path      = 'map_out/vid_results'
...
class MAP_vid(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        :'/home/hjh/BeltCrackDet/ablation/parameter_loss/loss_2025_06_12_10_37_42/ep0008-loss1.0255-val_loss1.3117.pth',
    ...
    def generate(self, onnx=False):
        self.net    = Network(self.num_classes, 5)  # 多帧
        # self.net = Network(1,"s")  # 单帧YOLOX
...
if __name__ == "__main__":
    ...
    if map_mode == 0 or map_mode == 1:
        # 验证参数 修改0.001 0.65
        yolo = MAP_vid(confidence = 0.003, nms_iou = 0.20)
