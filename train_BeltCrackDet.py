...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '/BeltCrackDet/model_data/classes.txt'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = '/BeltCrackDet/model_data/yolox_s.pth'
    #------------------------------------------------------#
    ...
    if True:
        ...
        # sequential-images (num=5)
        train_dataset = seqDataset(train_annotation_path, input_shape[0], 5, 'train')
        val_dataset = seqDataset(val_annotation_path, input_shape[0], 5, 'test') 
